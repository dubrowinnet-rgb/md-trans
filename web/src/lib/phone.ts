// Единый формат телефона в кабинете (Максим, 2026-09-25): +7(ХХХ)ХХХ-ХХ-ХХ
// везде — в списках, формах, выгрузке и при импорте.
...
// уже существующего клиента (используется и импортом, и formatPhone ниже).
