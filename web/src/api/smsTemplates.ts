...
// Шаблоны смс клиентам (доработки 1, п.2) — key стабильный (задан
// миграцией 0011), меняется только body. Та же таблица, что и на
// мобильном (mobile/src/api/smsTemplates.ts) — держать в одном виде.
